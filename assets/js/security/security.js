...
let employeesAttendanceInfo =
  JSON.parse(localStorage.getItem("employeesAttendanceInfo")) || [];
...
function updateLocalStorage() {
  localStorage.setItem(
    ...
    JSON.stringify(employeesAttendanceInfo)
  );
...
function filteredByStatus(status) {
  ...
  if (status === "All") {
    ...
    filtered = employeesAttendanceInfo.filter(
