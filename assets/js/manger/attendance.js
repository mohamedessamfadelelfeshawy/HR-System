...
/* attendance */
let attendants = await fetchEmployee("/assets/js/json/attendance_single_day.json");
...
search.addEventListener("input", (e) => {
  e.preventDefault();
  let arrFilter = attendants.filter(el => el.status.toLowerCase().includes(search.value.toLowerCase()));
